...
export default function Home() {
  ...
  return (
    <>
      <section>
        <div className="px-8 py-24 mx-auto md:px-12 lg:px-32 max-w-7xl mt-10">
          <div className="grid items-center grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-24">
            <div className="md:order-first">
              ...
              <h1 className="text-6xl font-semibold tracking-tighter text-[#F8E197] chakra-petch-bold text-balance">
                The Real FWUG
              </h1>
              <p className="mt-4 text-xl font-medium chakra-petch-medium text-[#65B1E0]">
                FWUG began with vision and artistry but was rugged by its
                original developer. We refused to let it die, appointing a CTO
                and reviving FWUG to reach its destined heights. This is more
                than a coin—it’s about preserving FWUG’s true potential. The
                real FWUG is here to stay, stronger than ever.
              </p>
              ...
              <div className="flex animate-on-scroll flex-col items-center gap-3 mt-10 md:flex-row">
                ...
                >
                  <span className=" text-xl text-[#F8E197]">Buy now $FGUW</span>
