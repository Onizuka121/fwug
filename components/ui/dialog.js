...
const DialogFooter = ({ className, ...props }) => (
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 text-[#F8E197]",
      className
    )}
    {...props}
  />
...
const DialogTitle = React.forwardRef(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-2xl chakra-petch-semibold text-[#F8E197] font-bold leading-none tracking-tight",
      className
    )}
    {...props}
  />
...
const DialogDescription = React.forwardRef(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-md text-muted-foreground chakra-petch-medium text-[#65B1E0]", className)}
    {...props}
  />
));
