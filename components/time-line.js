    ...
    <>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <h2 className="mb-6 text-6xl font-bold leading-none tracking-tight text-[#F8E197] chakra-petch-bold sm:text-4xl md:mx-auto">
          ...
          <p className="text-2xl chakra-petch-bold text-[#f8e197c5] md:text-lg">
            Charting the Path to Meme Domination
          </p>
        </div>
        <div className="relative grid gap-8 row-gap-5 mb-8 md:row-gap-8 lg:grid-cols-2 sm:grid-cols-2">
          ...
          <div className="p-6 w-full duration-300 transform backdrop-blur-3xl border border-[#f8e197] rounded-xl shadow-sm hover:-translate-y-2">
            <div className="flex items-center justify-between mb-2">
              ...
              <p className="flex text-xl p-4 items-center justify-center w-6 h-6 font-bold rounded text-deep-purple-accent-400 bg-[#f8e197]">
                1
              </p>
            </div>
            <p className="text-xl p-2 chakra-petch-medium text-[#65B1E0]">
          ...
          <div className="p-6 w-full duration-300 transform backdrop-blur-3xl border border-[#f8e197] rounded-xl shadow-sm hover:-translate-y-2">
            <div className="flex items-center justify-between mb-2">
              ...
              <p className="flex text-xl p-4 items-center justify-center w-6 h-6 font-bold rounded-md text-deep-purple-accent-400 bg-[#f8e197]">
                2
              </p>
            </div>
            <p className="text-xl p-2 chakra-petch-medium text-[#65B1E0]">
